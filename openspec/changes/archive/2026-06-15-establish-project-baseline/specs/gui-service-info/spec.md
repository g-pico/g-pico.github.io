...
The GUI service page SHALL support localized display through `data-i18n` attributes and its page-specific script.

#### Scenario: Visitor changes GUI service page language
- **WHEN** a visitor selects a supported language
- **THEN** visible labels and content controlled by the page script update to the selected language
