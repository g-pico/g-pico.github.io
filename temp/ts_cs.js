...
(function() {
  const GUI_TRANSLATIONS = {
    ...
    'section.terms.warranty_p1': 'After the project deliverable is handed over, the developer will provide a 2-month function warranty. Functional deficiencies discovered during this period can be corrected free of charge.',
    'section.terms.warranty_p2': 'In addition, within 6 months after project closing, we provide a maximum of 3 hours of online discussion and after-sales technical consultation service per month. If this time limit is exceeded, or if on-site support by the developer is required, the cost will be evaluated separately.',
    ...
    'zh-CN': {
      ...
      'section.terms.warranty_p1': '项目成果交付后，开发方将提供2 个月功能保固，             期间若发现项目功能缺失，可免费协助修正。',
      'section.terms.warranty_p2': '此外，项目结案后6 个月内，             每月提供最多3 小时的在线讨论与售后技术咨询服务。             若超过此时数，或需开发方到场（on-site）支持，将另行评估费用。',
